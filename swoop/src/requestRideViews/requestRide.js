...
function requestARide() {
  ...
  function getClosestRide(startLat, startLong) {
    axios
      .get(
        `http://localhost:8080/api/v1/rider/getRides?startLat=${startLat}&startLong=${startLong}`
      )
      .then((response) => {
        //var obj = json[0];
  ...
  function populateMatchedTripContainer(tripsList) {
  ...
  function joinRide() {
    axios
      .get(
        `http://localhost:8080/api/v1/user/joinRide?email=${userEmail}&rideID=${tripId}`
      )
      .then((response) => {
        console.log(response);
  ...
  return (
    <div className="container">
      ...
      <Helmet>
        ...
        <meta name="description" content="Swoop Get Ride Page" />
      </Helmet>
      <Navbar />
      <div id="tripBox">
        <div id="tripBoxTitle">
                ...
                onPress={() => {
                  if (origin.length > 0) {
                    getTrips(),
                      ...
                      requestSent(),
                      setTimeout(function () {
                        document.getElementById("tripBox").style.visibility =
                          "hidden";
                    ...
                    setTimeout(function () {
                      ...
                      document.getElementById("loadTripBox").style.visibility =
                        "hidden";
                    }, 14000);
                    setTimeout(function () {
                      document.getElementById(
                    ...
                    setTimeout(function () {
                      populateMatchedTripContainer(tripList);
                    }, 15500);
                  } else {
      ...
      <div id="matchedTripBox">
        ...
        <div className="matchedRideText"></div>
        <div id="joinRideBttn">
          <AwesomeButton
            cssModule={AwesomeButtonStyles}
            //   before={<CgProfile/>}
